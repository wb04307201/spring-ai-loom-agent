...
public class DefaultCompileAndDeployTool implements ICompileAndDeployTool {
    ...
    public CompileAndDeployResult compileAndDeploy(Map<String, Object> params, ToolContext toolContext) {
        ...
        try {
            ...
            File dockerfile = writeDockerfile(effectiveDir, jar);
    ...
    /**
     * 在 projectDir 下生成 Dockerfile —— 优先用 compile.baseImage，
     * 入口固定 {@code java -jar app.jar}。
     */
    File writeDockerfile(Path projectDir, File jar) {
        ...
        String content = String.format("""
                ...
                """, compile.getBaseImage(), jar.getName(), compile.getDefaultPort());
        try {
